...
```{r corr-0q, echo = FALSE, out.width='65%', out.height='65%',fig.show='hold',fig.align='center', fig.cap='Correlation plot between des-seasonalized SST and mean precipitation in the CAB for timelag 0'}
