# cv lasso oirignal data but with scaling
getwd()
...
target <- target[1:370]
lasso_on_og_scale_data <- cv_for_ts(features, target, nfold = 5, size_train = 60, size_test = 14,
                                    save_folder = "cv-lasso-og-center-11-06-22")
# plot results
...
plot_and_save_cv_results(err_mat, 5, ids, lambdas, features, target,
                         save_to = "results/CV-lasso/cv-lasso-og-center-11-06-22")
