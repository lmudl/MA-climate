...
de_precip_cv <- readRDS("data/processed/precip_cv.rds")

des_sst_eval <- readRDS("data/processed/des_sst_eval.rds")
des_precip_eval <- readRDS("data/processed/precip_eval.rds")


# fit full model
l_min = exp(0.8)
full_model <- glmnet(des_sst_cv, precip_cv, lambda=l_min,
                     standardize=FALSE)
# save full model
