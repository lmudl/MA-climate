...
Definition unbiased
Q:
intuition behind estimated $\beta_1$, denominator looks like covariance
...
Q:
Expected value is minimising mean squared error
...
Q: 
Does that mean for example after accounting for confounders the y_i are cond independent?
