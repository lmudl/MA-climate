...
```
```{r}
path_to_model_folder <- "../results/CV-fused/small-fused-1k-stand/"
```
...
```{r}
pred_full <- readRDS(paste0(path_to_model_folder, "pred-plots/pred-plot-full.rds"))
get_mse_from_pred_plot(pred_full)
pred_full
```
