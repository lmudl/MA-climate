...
## Error plots
```{r}
p1 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-1.rds")
err_mat <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat.rds")
...
```{r}
p1 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-1.rds")
p2 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-2.rds")
p3 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-3.rds")
p4 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-4.rds")
p5 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/err-mat-plots/err-plot-fold-5.rds")
p1 + p2 + p3 + p4 + p5
```
## Coefficient plots

```{r}
pc1 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/coef-plots/coef-plot-fold-1.rds")
pc2 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/coef-plots/coef-plot-fold-2.rds")
pc3 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/coef-plots/coef-plot-fold-3.rds")
pc4 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/coef-plots/coef-plot-fold-4.rds")
pc5 <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/coef-plots/coef-plot-fold-5.rds")
...
```{r}
# get indices
lambdas <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/lambda-vec.rds")
ids <- readRDS("../results/CV-lasso/cv-lasso-original-corr-pre-spearman/index-list.rds")
```
