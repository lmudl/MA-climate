...
```{r}
# p1 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/err-mat-plots/err-plot-fold-1.rds")
# p2 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/err-mat-plots/err-plot-fold-2.rds")
# p3 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/err-mat-plots/err-plot-fold-3.rds")
# p4 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/err-mat-plots/err-plot-fold-4.rds")
# p5 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/err-mat-plots/err-plot-fold-5.rds")
# p1 + p2 + p3 + p4 + p5
```
...
```{r}
# pc1 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/coef-plots/coef-plot-fold-1.rds")
# pc2 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/coef-plots/coef-plot-fold-2.rds")
# pc3 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/coef-plots/coef-plot-fold-3.rds")
# pc4 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/coef-plots/coef-plot-fold-4.rds")
# pc5 <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/coef-plots/coef-plot-fold-5.rds")
# 
...
# features_og <- load_data(features_path, "sst")
# dim(features_og)
# features_og <- t(features_og)
# dim(features_og)
# features_og <- prepare_sst(features_og)
# dim(features_og)
features <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/timelag_features.rds")
dim(features)
any(is.na(features))
```
...
ids <- readRDS("../results/CV-lasso/cv-lasso-og-timelag-03-06-22/index-list.rds")
```
...
#dim(features)
m_full <- glmnet(features[1:370,], target[4:373], lambda = best_lambda, standardize = FALSE)
dim(features)
preds_full <- predict(m_full, newx = features[370:429,],
                      lambda = best_lambda)
df <- data.frame(preds = preds_full, target = target[373:432])
#dim(preds_full)
ggplot() + geom_line(data = df, mapping = aes(x=1:60, y=s0, colour = "blue")) +
  geom_line(data = df, mapping= aes(x=1:60, y=target))
