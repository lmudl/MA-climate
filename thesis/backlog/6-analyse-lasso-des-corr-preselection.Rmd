# Lasso on deseasonalised data with correlation preselection
```{r}
...
## Error plots
```{r}
p1 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-1.rds")
...
```{r}
p1 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-1.rds")
p2 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-2.rds")
p3 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-3.rds")
p4 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-4.rds")
p5 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/err-mat-plots/err-plot-fold-5.rds")
p1 + p2 + p3 + p4 + p5
```
## Coefficient plots

```{r}
pc1 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/coef-plots/coef-plot-fold-1.rds")
pc2 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/coef-plots/coef-plot-fold-2.rds")
pc3 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/coef-plots/coef-plot-fold-3.rds")
pc4 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/coef-plots/coef-plot-fold-4.rds")
pc5 <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/coef-plots/coef-plot-fold-5.rds")
...
ids <- readRDS("../results/CV-lasso/cv-lasso-on-corr-des/index-list.rds")
```
