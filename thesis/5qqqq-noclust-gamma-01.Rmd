...
```{r}
# inspect the models
# model_list <- load_models(paste0(path_to_model_folder, "fold-models"))
# m1 <- model_list[[1]]
# b1 <- m1$beta
# vec <- apply(b1, 1, sum)
# sum(vec!=0)
...
```{r ,eval=FALSE fig.cap="Coefficient map plot for the different folds. Longitude and Latitude on the x and y-axis respectively. Positive values are coloured in blue, negative values in red."}
