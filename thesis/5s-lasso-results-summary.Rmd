...
The minimal MSE is found at `r round(log(lambda1),2)`
...
```{r coef-plot-full-lasso-og, fig.cap=paste("Coefficient plot of the full lasso model with fitted intercept of", intercept1)}
